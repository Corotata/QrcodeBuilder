...
- (void)viewDidLoad {
    ...
    self.imageView2.image = [UIImage coro_createQRCodeWithText:@"My love!!!!!" size:self.imageView2.frame.size.width centerImage:[UIImage imageNamed:@"abc"]];
    ...
    self.imageView4.image = [UIImage coro_createQRCodeWithText:@"有点无聊！" size:self.imageView4.frame.size.width centerImage:[UIImage imageNamed:@"abc"] AndTransformColorWithRed:1.0f andGreen:10.0f andBlue:124.0f];
